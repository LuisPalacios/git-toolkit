...
func TestResolveRepoPath(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			sourceFolder: "github",
			repoName:     "LuisPalacios/my-repo",
			wantSuffix:   sep + "github" + sep + "LuisPalacios" + sep + "my-repo",
		},
		{
			name:         "id_folder override: changes 2nd level",
			globalFolder: "/home/user/git",
			sourceFolder: "github",
			repoName:     "Sumwall/sumwall.web",
			repo:         config.Repo{IdFolder: "sumwall-rest"},
			wantSuffix:   sep + "github" + sep + "sumwall-rest" + sep + "sumwall.web",
		},
		{
			name:         "clone_folder override: changes 3rd level",
			globalFolder: "/home/user/git",
			sourceFolder: "github",
			repoName:     "Sumwall/sumwall.github.io",
			repo:         config.Repo{CloneFolder: "website"},
			wantSuffix:   sep + "github" + sep + "Sumwall" + sep + "website",
		},
		{
			name:         "both overrides",
			globalFolder: "/home/user/git",
